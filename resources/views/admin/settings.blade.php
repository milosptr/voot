...
@section('title', 'Stillingar Voot')

@section('content')
@section('page-title', 'Stillingar')
  <main class="relative">
    <div class="pb-6">
        ...
        <div class="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x">
          <aside class="py-6 lg:col-span-3">
            <header class="relative mb-5">
              <div class="px-3">
                <h1 class="text-lg font-medium">Stillingar</h1>
              </div>
            </header>
            <nav class="space-y-1 settings-page">
              <a href="/backend/settings/product-icons" class="border-transparent text-gray-900 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
                  <svg class="flex-shrink-0 -ml-1 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="currentColor" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M120,208H40a8,8,0,0,1-8-8V64a8,8,0,0,1,8-8H93.3a8.1,8.1,0,0,1,4.8,1.6l27.8,20.8a8.1,8.1,0,0,0,4.8,1.6H216a8,8,0,0,1,8,8v32" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></path><polygon points="188 198.5 217.7 216 209.6 183.4 236 161.6 201.3 158.9 188 128 174.7 158.9 140 161.6 166.4 183.4 158.3 216 188 198.5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="14"></polygon></svg>
                  <span class="truncate"> Vörutákn </span>
                </a>
                <a href="/backend/settings/product-translation" class="border-transparent text-gray-900 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
                  <svg class="flex-shrink-0 -ml-1 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="192" height="192" fill="currentColor" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><polyline points="232 216 176 104 120 216" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></polyline><line x1="136" y1="184" x2="216" y2="184" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></line><line x1="88" y1="32" x2="88" y2="56" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></line><line x1="24" y1="56" x2="152" y2="56" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></line><path d="M120,56a96,96,0,0,1-96,96" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></path><path d="M61.5,88A95.9,95.9,0,0,0,152,152" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></path></svg>
                  <span class="truncate"> Erlendar þýðingar á vörum </span>
                </a>
                <a href="/backend/settings/staff" class="border-transparent text-gray-900 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
                  ...
                  <span class="truncate"> Starfsfólk </span>
                </a>
                </a>
                <a href="/backend/settings/locations" class="border-transparent text-gray-900 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
                  ...
                  <span class="truncate"> Staðsetningar </span>
                </a>
                <a href="/backend/settings/pages" class="border-transparent text-gray-900 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
                  ...
                  <span class="truncate"> Skilmálasíður </span>
                </a>
                <a href="/backend/settings/newsletter" class="border-transparent text-gray-900 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
                  ...
                  <span class="truncate"> Fréttabréf/Tilboð </span>
                </a>
                <a href="/backend/settings/homepage-products" class="border-transparent text-gray-900 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
                  <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 -ml-1 mr-3 h-6 w-6" fill="currentColor" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M224,177.3V78.7a8.1,8.1,0,0,0-4.1-7l-88-49.5a7.8,7.8,0,0,0-7.8,0l-88,49.5a8.1,8.1,0,0,0-4.1,7v98.6a8.1,8.1,0,0,0,4.1,7l88,49.5a7.8,7.8,0,0,0,7.8,0l88-49.5A8.1,8.1,0,0,0,224,177.3Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></path><polyline points="222.9 74.6 128.9 128 33.1 74.6" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></polyline><line x1="128.9" y1="128" x2="128" y2="234.8" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></line></svg>
                  <span class="truncate"> Vörur á upphafssíðu </span>
                </a>
                <a href="/backend/settings/colors" class="border-transparent text-gray-900 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
                  <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 -ml-1 mr-3 h-6 w-6" fill="currentColor" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M221.6,149.4a96.2,96.2,0,0,0,2.4-22.2c-.4-52.9-44.2-95.7-97-95.2A96,96,0,0,0,96,218.5a23.9,23.9,0,0,0,32-22.6V192a23.9,23.9,0,0,1,24-24h46.2A24,24,0,0,0,221.6,149.4Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></path><circle cx="128" cy="76" r="10"></circle><circle cx="83" cy="102" r="10"></circle><circle cx="83" cy="154" r="10"></circle><circle cx="173" cy="102" r="10"></circle></svg>
                  <span class="truncate"> Litir </span>
                </a>
                <a href="/backend/settings/config" class="border-transparent text-gray-900 hover:text-gray-900 group border-l-4 px-3 py-2 flex items-center text-sm font-medium">
                  ...
                  <span class="truncate"> Viðtakendur pantana </span>
                </a>
            </nav>
          </aside>
