...
@section('content')
  <section>
    <div class="flex gap-5">
      <a href="/backend/products" class="bg-white rounded-md shadow border border-gray-100 px-6 py-3 flex items-center text-right">
      ...
      <a href="/backend/categories" class="bg-white rounded-md shadow border border-gray-100 px-6 py-3 flex items-center text-right">
      ...
      <a href="/backend/orders" class="bg-white rounded-md shadow border border-gray-100 px-6 py-3 flex items-center text-right">
