...
@section('content')
  <section class="flex items-center justify-center page-not-found-section">
    <div class="w-full sm:w-1/2 text-center">
      <h2 class="text-primary-lighter font-bold tracking-wider">404 ERROR</h2>
      <h1 class="text-5xl font-bold my-2">{{ __('default.page_not_found') }}</h1>
      <p class="text-warmGray-500">{{ __('default.page_not_found_subtitle') }}</p>
