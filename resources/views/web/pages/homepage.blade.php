...
@section('content')
  ...
  <section class="relative py-32">
    <div class="absolute top-0 left-0 h-screen w-full z-0 bg-cover bg-top bg-no-repeat" style="background-image: url('/images/waves-haikei-2.svg');"></div>
  ...
  <section class="my-32">
    <div class="container mx-auto relative">
      <div class="bg-gray-200 bg-opacity-80 rounded-md flex flex-col justify-center items-center py-12 px-20">
        <div class="w-full sm:w-3/4">
          ...
          <div class="flex justify-center">
            <div class="text-primary-light tracking-wide uppercase">{{ __('default.quote_author') }}</div>
          </div>
        </div>
      </div>
    </div>
