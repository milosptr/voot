...
<section class="bg-white py-20">
  <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
      ...
      <h1 class="mb-4 text-4xl font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-5xl xl:text-6xl">Viðhald í gangi</h1>
      <p class="font-light text-gray-500 md:text-lg xl:text-xl">Skipulögð viðhaldsverk eru framkvæmd af kerfisstjórnum fyrirtækisins. Þakka þér fyrir þolinmæðina</p>
  </div>
</section>
  {{-- <section>
  ...
  <input id="cart" type="text" value="{{ $cart }}" hidden /> --}}
@endsection
