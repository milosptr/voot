                ...
                <div class="mt-6 order-2 sm:order-1">
                    <div class="">
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                            <div>
                                <label for="selectedCustomer" class="block text-sm font-medium text-gray-700">Nafn /
                                    Fyrirtæki</label>
                                <div class="mt-1">
                                    <select id="selectedCustomer" name="customerKey"
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <div type="text"
                                        class="block w-full rounded-md bg-white cursor-not-allowed border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        {{ auth()->user()->ssn ?? '/' }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <div type="text"
                                                class="bg-white cursor-not-allowed block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                                {{ auth()->user()->city ?? '/' }}
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="mt-10 border-t border-gray-200 pt-10">
                        ...
                        <fieldset>
                            <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                <label for="delivery-method--delivery"
                                    class="relative flex cursor-pointer rounded-lg border-2 border-transparent border-solid bg-white p-4 shadow-sm focus:outline-none delivery-method-active">
                                    <input type="radio" id="delivery-method--delivery" checked name="shippingMethod"
                                        value="delivery" class="sr-only" aria-labelledby="delivery-method-0-label"
                                    ...
                                    <span class="flex flex-1">
                                        <span class="delivery-content flex flex-col">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-gray-700"
                                                fill="currentColor" viewBox="0 0 256 256">
                                                <rect width="256" height="256" fill="none"></rect>
                                                <path d="M176,80h42.6a7.9,7.9,0,0,1,7.4,5l14,35" fill="none"
                                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="12"></path>
                                                <line x1="16" y1="144" x2="176" y2="144"
                                                ...
                                                <circle cx="68" cy="192" r="24" fill="none"
                                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="12"></circle>
                                                <line x1="164" y1="192" x2="92" y2="192"
                                                    fill="none" stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="12"></line>
                                                <path d="M44,192H24a8,8,0,0,1-8-8V72a8,8,0,0,1,8-8H176V171.2"
                                                    fill="none" stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="12"></path>
                                                <path d="M176,120h64v64a8,8,0,0,1-8,8H212" fill="none"
                                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="12"></path>
                                            </svg>
                                            <span id="delivery-method-0-label"
                                                class="block text-base font-medium text-gray-900">Senda</span>
                                        </span>
                                    </span>
                                ...
                                <label for="delivery-method--pickup"
                                    class="relative flex cursor-pointer rounded-lg border-2 border-transparent border-solid bg-white p-4 shadow-sm focus:outline-none">
                                    <input type="radio" id="delivery-method--pickup" name="shippingMethod"
                                        value="pickup" class="sr-only" aria-labelledby="delivery-method-1-label"
                                        ...
                                        <span class="delivery-content flex flex-col">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-gray-700"
                                                ...
                                                <path
                                                    ...
                                                    fill="none" stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="12"></path>
                                                <path d="M96,96v16a32,32,0,0,1-64,0V96" fill="none"
                                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="12"></path>
                                                <path d="M160,96v16a32,32,0,0,1-64,0V96" fill="none"
                                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="12"></path>
                                                <path d="M224,96v16a32,32,0,0,1-64,0V96" fill="none"
                                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="12"></path>
                                            </svg>
                                            <span id="delivery-method-1-label"
                                                class="block text-base font-medium text-gray-900">Sækja</span>
                                        </span>
                                    </span>
                                    <svg class="h-5 w-5 text-indigo-600" viewBox="0 0 20 20" fill="currentColor"
                                        aria-hidden="true">
                    ...
                    <div class="mt-10 border-t border-gray-200 pt-10">
                        ...
                        <div id="method--delivery" class="mt-4 grid grid-cols-1 gap-y-6 sm:gap-x-4">
                            <div>
                                <label for="deliveryMethods" class="block text-sm font-medium text-gray-700">Nafn /
                                    Fyrirtæki</label>
                                <div class="mt-1">
                                    <select id="deliveryMethods" name="shippingMethodCode"
                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        @php
                                            $defaultDeliveryMethod = auth()->user()->default_shipping_id;
                                        @endphp
                                        @foreach (App\Models\ShippingMethod::get() as $company)
                                            <option value="{{ $company['id'] }}"
                                                {{ $defaultDeliveryMethod === $company['id'] ? 'selected="true"' : '' }}>
                                                {{ $company['name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <div type="text"
                                        ...
                                        {{ auth()->user()->zip }}, {{ auth()->user()->country ?? '' }}
                                    </div>
                                </div>
                            </div>
                            <div>
                                <label for="different_address" class="block text-sm font-medium text-gray-700">Annar
                                    afgreiðslustaður (valfrjálst)</label>
                                <div class="mt-1">
                                    <input type="text" id="different_address" name="shippingAddress"
                                        placeholder="Afhendingarstaður..."
                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                                </div>
                            </div>
                        </div>
                                ...
                                @foreach (App\Models\Location::all() as $location)
                                    <div class="text-gray-500 flex gap-2 items-center cursor-pointer">
                                        <input type="radio" name="pickupLocation"
                                            {{ $location->id === 1 ? 'checked="checked"' : '' }}
                                            value="{{ $location->id }}" id="pickup-{{ $location->id }}"
                                            class="focus:ring-0 h-4 w-4 text-primary-lighter border-gray-300">
                        ...
                        <div class="my-6">
                            <label for="different_date" class="block text-sm font-medium text-gray-700">Dagsetning
                                sendingar (valfrjálst)</label>
                            <div class="mt-1">
                                <input type="date" id="different_date" name="shippingDate"
                                    placeholder="Afhendingarstaður..."
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                            </div>
                        </div>
                    ...
                    <div class="mt-10">
                        <button type="submit"
                            class="w-full flex justify-center items-center small-caps uppercase px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 cursor-pointer">Panta</button>
                    </div>
                </div>
                            ...
                            @foreach (auth()->user()->getCartItems() as $product)
                                <div class="py-2 flex items-center gap-4">
                                    <img src="/{{ $product['featured_image'] }}"
                                        onerror="this.src='/images/placeholder.png';this.onerror='';"
                                        class="aspect-1 w-10">
                                    <div>
                                        <a href="{{ $product['url'] }}" target="_blank">{{ $product['name'] }}<span
                                                class="font-medium"> x {{ $product['qty'] }}</span></a>
