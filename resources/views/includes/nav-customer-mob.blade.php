<a href="/app" class="bg-gray-900 text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
...
<a href="/app/orders" class="text-gray-300 hover:bg-primary-lighter hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
