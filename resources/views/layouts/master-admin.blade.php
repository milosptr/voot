...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;1,400&display=swap"
        rel="stylesheet">
        ...
        <div id="admin-navigation" class="fixed inset-0 flex z-40 md:hidden" role="dialog" aria-modal="true">
            ...
            <div class="relative flex-1 flex flex-col max-w-xs w-full bg-primary">
                <div class="absolute top-0 right-0 -mr-12 pt-2">
                    <button id="close-admin-navigation" type="button"
                ...
                <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    <div class="flex items-center  flex-shrink-0 px-4">
                        ...
                        @if (auth()->user()->logo)
                            ...
                            <div class="w-24 h-20 bg-center bg-no-repeat bg-contain"
                                style="background-image: url('/{{ auth()->user()->logo }}')"></div>
                        @endif
                    </div>
        ...
        <div class="md:pl-64 flex justify-between">
            <div class="fixed w-full top-0 z-10 md:hidden bg-white border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <button id="open-admin-navigation" type="button"
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm text-yellow-700">
                                                Aðgangur þinn bíður ennþá samþykkis starfsfólks Voot. Vinsamlegast <a
                                                    href="mailto:steini@voot.is"
                                                    class="font-medium underline text-yellow-700 hover:text-yellow-600">hafðu
                                                    samband</a> beint til að flýta fyrir ferlinu!
                                            </p>
                                        </div>
                                    </div>
                                </div>
