...
<head>
    ...
    <meta name="description"
        content="Voot býður upp á þrautreyndar rekstrarvörur fyrir sjó og land á hagstæðu verði, allt á einum stað" />
...
<body class="voot">
    @if (!Route::is('login') && !Route::is('register') && !Route::is('forgot_password') && !Route::is('get-account'))
        @include('web.navigation')
    @endif
    @include('web.common.subaccount-active')
    @yield('content')
    @if (!Route::is('login') && !Route::is('register') && !Route::is('forgot_password') && !Route::is('get-account'))
        @include('web.footer')
    @endif
