<tr onclick="window.open('/backend/products/edit/{{ $product->id }}')" class="cursor-pointer hover:bg-gray-50">
  <td class="px-6 py-4 whitespace-nowrap">
    <div class="flex items-center">
      <div class="h-10 w-10 rounded-md bg-center bg-contain bg-no-repeat" style="background-image: url('/{{ isset($product->featured_image) ? $product->featured_image['file_path'] : 'images/product-placeholder.png' }}')"></div>
    </div>
  </td>
  <td class="px-6 py-4 whitespace-nowrap">
