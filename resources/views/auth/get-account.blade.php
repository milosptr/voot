                    ...
                    <div class="mt-6">
                        <form id="account-request" action="/api/account-request" method="POST" class="space-y-6">
                            ...
                            <div id="account-exists-alert"
                                ...
                                Reikningurinn með þessu kennitala er þegar til í kerfinu okkar. Þú getur fengið nýtt
                                lykilorð fyrir reikninginn þinn með því <a href="/forgot-password">að smella hér</a>.
                            </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="mt-1">
                                        <input id="company" name="company" type="text" autocomplete="company"
                                            placeholder="Nafn fyrirtækis" required
                            ...
                            <div class="flex justify-between items-center">
                                <div class="w-full pr-3">
                                    ...
                                    <div class="mt-1">
                                        <input id="company_ssn" name="company_ssn" type="number" autocomplete="company_ssn"
                                            placeholder="Fyrirtæki kennitala" required
                                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                </div>
                                <div class="w-full pl-3">
                                    ...
                                    <div class="mt-1">
                                        <input id="ssn" name="ssn" type="number" autocomplete="ssn"
                                ...
                                <div class="w-full pl-3">
                                    ...
                                    <div class="mt-1">
                                        <input id="invoice_email" name="invoice_email" type="email"
                                            autocomplete="invoice_email" placeholder="user@email.com" required
                                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                </div>
                            </div>
