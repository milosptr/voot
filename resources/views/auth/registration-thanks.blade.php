...
<section class="flex items-center justify-center page-not-found-section">
    <div class="w-full sm:w-1/2 text-center">
      <h2 class="text-primary-lighter font-bold tracking-wider">Registration Pending</h2>
      <h1 class="text-5xl font-bold my-2">Thank You</h1>
      <p class="text-warmGray-500">We are now processing your registration, you will get an email when you are approved.<br>You can now create order.</p>
