        ...
        <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-lg lg:w-full">
                <div>
                    ...
                    <p class="mt-2">Vinsamlegast athugið að það getur tekið allt að 2 virka daga að stofna nýja
                        viðskiptavini í viðskipti hjá Voot.</p>
                    <p class="mt-2 font-medium">Vinsamlegast athugaðu að engin verð eru aðgengileg á pöntunarsíðunni.</p>
                    <p class="mt-2 font-medium">Við reynum að lágmarka pappirsnotkun og allir reikningar eru sendir rafrænt,
                        því er nauðsynlegt að gefa upp tölvupóst sem reikningar sendast á.</p>
                </div>
                ...
                <div class="mt-8">
                    @error('email')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative text-xs font-semibold"
                            role="alert">
                    ...
                    <div class="mt-6">
                        <form id="register-me" action="/register-me" method="POST" class="space-y-3">
                            @csrf
                            <div id="account-exists-alert"
                                class="hidden text-sm py-2 px-3 rounded-md bg-yellow-100 border border-yellow-400">
                                Þessi kennitala er nú þegar skráð hjá okkur. Þú getur fengið lykilorð fyrir aðgang með Því
                                <a href="/get-account">að smella hér</a>.
                            </div>
                            <div class="w-full">
                                ...
                                <div class="mt-1">
                                    <input id="ssn" name="ssn" type="ssn" autocomplete="ssn"
                                        placeholder="Kennitala" required
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="w-full pl-3">
                                    ...
                                    <div class="mt-1">
                                        <input id="invoice_email" name="invoice_email" type="email" autocomplete="email"
                                            placeholder="user@email.com" required
                                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                </div>
                                ...
                                <div class="w-full pl-3">
                                    ...
                                    <div class="mt-1">
                                        <input id="phone" name="phone" type="phone" autocomplete="phone"
                                            placeholder="+354 xxx xxxx" required
                                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-full pr-3">
                                    ...
                                    <div class="mt-1">
                                        <input id="street" name="street" type="text" autocomplete="street"
                                            placeholder="Heimilisfang" required
                                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                </div>
                                <div class="w-full pl-3">
                            ...
                            <div class="flex justify-between items-center">
                                <div class="w-full pr-3">
                                    ...
                                    <div class="mt-1">
                                        <input id="zip" name="zip" type="text" autocomplete="zip"
                                            placeholder="Postnúmer" required
                                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                </div>
                                <div class="w-full pl-3">
                            ...
                            <div class="w-full">
                                ...
                                <button type="submit"
                                    class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-light hover:bg-primary focus:outline-none duration-300 transition-all ease-in-out">Nýskráning</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="mt-6">
                    ...
                    <div class="mt-6">
                        <a href="/login"
                            class="w-full flex justify-center py-2 px-4 rounded-md shadow-sm text-sm font-medium text-black border-1 border-solid border-primary-light  focus:outline-none">
                            Skrá inn
                        </a>
                    </div>
                </div>
