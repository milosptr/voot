<template>
  <div v-click-away="onClickOutside" :class="classes">
    ...
    <div class="mt-1 relative">
      <button type="button" class="bg-white relative flex items-center border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" @click="show = !show">
